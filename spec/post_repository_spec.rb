...
RSpec.describe PostRepository do
  ...
  context '#all' do
    xit 'returns all the posts' do
      ...
      expect(posts[2].contents).to eq 'Got some beans'
  ...
  context '#find' do
    xit 'returns the first post' do
      ...
      expect(post.contents).to eq '30 today!'
  ...
  context '#create' do
    xit 'creates a new post' do
      ...
      expect(post.contents).to eq 'please ignore'
  ...
  context '#delete' do
    xit 'deletes the first post' do
      ...
      expect(post.contents).to eq 'Dead today!'
